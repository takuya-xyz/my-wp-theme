...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="<?php echo get_template_directory_uri(); ?>/images/top_image/top_image_1.jpg" alt="写真1">
      <div class="carousel-caption">
        <h1></h1>
      </div>
    </div>
    <div class="item">
      <img src="<?php echo get_template_directory_uri(); ?>/images/top_image/top_image_2.jpg" alt="写真2">
      <div class="carousel-caption">
        <h1></h1>
      </div>
    </div>
    <div class="item">
      <img src="<?php echo get_template_directory_uri(); ?>/images/top_image/top_image_3.jpg" alt="写真3">
      <div class="carousel-caption">
        <h1></h1>
      </div>
    </div>
...
<ul>
<li style="font-size:10px;color:#fff;line-height:120%;padding-top:8px;">
WEBサイト制作<br />
アウトドアチャイルド
</li>
